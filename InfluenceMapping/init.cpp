...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    //キャラクターチップロード
    life::Player player;
    std::array<int, life::num_c_chip_ALL> pl_chip = player.getCharacterchip();
    LoadDivGraph("ghost.png", life::num_c_chip_ALL, life::num_c_chip_X, life::num_c_chip_Y, life::size_character_X, life::size_character_Y, std::data(pl_chip));
